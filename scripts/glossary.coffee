...
module.exports = (robot) ->
  robot.respond /what is (.*)\??/i, (msg) ->
    ...
    items.push
        title:"cloud", content:"It basically means NOT YOUR COMPUTER"
    items.push
        title:"darkdrgn2k", content:"He's Dark, Hes Dragonny and hes 2000"
    items.push
        title:"charlie", content:"He's a C in a circle"
    items.push
        title:"garry", content:"He's a google maps blur"
    items.push
        title:"heavymetal", content:"He's a ninja at a computer"
    items.push
        title:"makeworld", content:"He's not a square.. he's a cube"
