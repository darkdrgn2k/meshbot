...
module.exports = (robot) ->
  ...
  robot.hear /(#fakenews)/i, (res) ->
     res.send "https://cdn-images-1.medium.com/max/1181/1*Y0NeQqkMifDS8mQQJZu7aA.png"
...
#    res.send 'Toronto Mesh Code of Conduct: https://tomesh.net/code-of-conduct/'
  ...
  robot.hear /(#racoon)/i, (res) ->
    res.send 'https://thumbs.gfycat.com/BothLittleBinturong-max-1mb.gif'
